...
_C.MODEL.TYPE = 'swin'
# Model name
_C.MODEL.NAME = 'SLDDBD_patchsize32_swin_ratio0.5_img224_statefarm_110ep'
# Checkpoint to resume, could be overwritten by command line argument
_C.MODEL.PRETRAINED = ''

_C.MODEL.RESUME = 'SLDDBD_patchsize32_swin_ratio0.5_img224_statefarm_110ep'
