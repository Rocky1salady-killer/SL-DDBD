...
def parse_option():
    ...
    parser.add_argument('--cfg', default='configs/SLDDBD_patchsize32_swin_ratio0.5_img224_statefarm_110ep', type=str, metavar="FILE",
...
checkpoint = torch.load('../SLDDBD_patchsize32_swin_ratio0.5_img224_statefarm_110ep.pth', map_location='cpu')
